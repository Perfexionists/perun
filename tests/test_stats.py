...
def test_stats_lists(pcs_full_no_prof):
    ...
    _check_objects([(minor_root, ['root_stats', 'root_stats_2']), (minor_head, ['head_stats'])],
                   [], [])
...
def test_stats_files_delete(pcs_full_no_prof):
    ...
    _check_objects([(minor_head, []), (minor_middle, ['custom_stats', 'middle_stats']),
...
def test_stats_directories_delete(pcs_full_no_prof):
    ...
    stats._delete_stats_objects([os.path.join(stats_dir, 'invalid_dir')],
    ...
    _check_objects([(minor_head, ['custom_stats']), (minor_middle, ['middle_stats']),
                    (minor_root, [])], [custom_dir, custom_root_dir],
    ...
    os.mkdir(os.path.join(stats_dir, custom_dir))
    _check_objects([(minor_root, []), (minor_middle, [])], [custom_root_dir, custom_dir],
    ...
    fake_version_parts = (minor_root[:2],
    ...
    _check_objects([(minor_root, []), (minor_middle, []), (fake_version, [])],
                   [custom_root_dir, custom_dir], [custom_root_file, custom_file])
...
def test_stats_sync(pcs_full_no_prof):
    ...
    _check_objects([(minor_head, ['head_stats', 'custom_file']), (minor_middle, [])],
                   [stats_custom_dir], [root_custom], check_index=False)
...
def _check_objects(versions_with_files, custom_empty_dirs, custom_files, with_index=True,
                   check_index=True):
    ...
    stats_objects = _transform_paths(versions_with_files, custom_empty_dirs, custom_files,
                                     with_index)

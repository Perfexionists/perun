...
from perun.profiles import native as profile, conversions
...
def from_binary(ctx: click.Context, import_entries: list[str], **kwargs: Any) -> None:
    ...
    conversions.perf_native.import_perf_from_record(import_entries, **kwargs)
...
def from_text(ctx: click.Context, import_entries: list[str], **kwargs: Any) -> None:
    ...
    """
    kwargs.update(ctx.obj)
    conversions.perf_native.import_perf_from_script(import_entries, **kwargs)
...
def from_stacks(ctx: click.Context, import_entries: list[str], **kwargs: Any) -> None:
    ...
    """
    kwargs.update(ctx.obj)
    conversions.perf_native.import_perf_from_stack(import_entries, **kwargs)
...
def from_json(ctx: click.Context, import_entries: list[str], **kwargs: Any) -> None:
    ...
    """
    kwargs.update(ctx.obj)
    conversions.elk_native.import_elk_from_json(import_entries, **kwargs)

...
class WholeRepositorySelection(AbstractBaseSelection):
    ...
    def get_parents(self, target_version: MinorVersion) -> list[MinorVersion]:
        ...
        """
        return [vcs.get_minor_version_info(parent) for parent in target_version.parents]
    ...
    def get_profiles(
        ...
        for parent in target_version.parents:
            parent_info = vcs.get_minor_version_info(parent)
    ...
    def get_skeleton_for_profile(
        ...
        """
        for minor_version in vcs.walk_minor_versions(target_version.checksum):
    ...
    def get_skeleton(self, target_version: MinorVersion) -> Iterator[MinorVersion]:
        ...
        """
        yield from vcs.walk_minor_versions(target_version.checksum)

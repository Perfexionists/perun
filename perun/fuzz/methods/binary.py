...
def insert_byte(lines: list) -> None:
...
@randomizer.random_repeats(RULE_ITERATIONS)
def remove_byte(lines: list) -> None:
...
@randomizer.random_repeats(RULE_ITERATIONS)
def remove_zero_byte(lines: list) -> None:
...
@randomizer.random_repeats(RULE_ITERATIONS)
def insert_zero_byte(lines: list) -> None:

...
def flattened_values(root_key: Any, root_value) -> Iterable[tuple[str, str | float]]:
...
def all_items_of(resource: dict) -> Iterable[tuple[str, str | float]]:
...
def _all_fields_of(item_generator: Iterable[tuple[int, dict]]) -> Iterable[str]:
...
def unique_resource_values_of(profile: Profile, resource_key: str) -> Iterable:
...
def all_key_values_of(resource: dict, resource_key: str) -> Iterable:
...
def unique_model_values_of(profile: Profile, model_key: str) -> Iterable:
...
def _unique_values_generator(key: str, blocks_gen: Iterable) -> Any:

...
def get_minor_head() -> str:
    ...
    try:
        ...
        return helpers.dynamic_module_function_call(
...
def is_dirty() -> bool:
    ...
    """
    vcs_type, vcs_path = pcs.get_vcs_type_and_url()
    return helpers.dynamic_module_function_call("perun.vcs", vcs_type, "_is_dirty", vcs_path)
...
def save_state() -> tuple[bool, str]:
    ...
    vcs_type, vcs_path = pcs.get_vcs_type_and_url()
    return helpers.dynamic_module_function_call("perun.vcs", vcs_type, "_save_state", vcs_path)
